...
export default function AccordionProduct() {
  ...
  const items = [
    ...
    },
    {
      ...
      content:
        "Shipping:is free on US , Canada orders are R3,150 Returns: Unwashed, unworn items are eligible for returns or exchanges within 30 days of purchase. Final Sale items are not eligible for returns or exchanges.",
    },
  ];
